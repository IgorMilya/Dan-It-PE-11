...
// 2. Чтобы наша функция была оптимальной и принимать любые числа, значения. Чтобы не переписывать заново всю функцию
//    под определённые числа, мы пишем аргументы и в конце передаём, то что мы хотим передать.
